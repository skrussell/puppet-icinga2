...
describe 'icinga2_attributes' do
  ...
  it 'assign a string' do
    ...
    # foo = "some string"
    is_expected.to run.with_params({'foo' => 'some string'}).and_return("foo = \"some string\"\n")

    # vars.foo = "some string"
    is_expected.to run.with_params({'vars' => {'foo' => 'some string'}}).and_return("vars.foo = \"some string\"\n")
  end
  ...
  it 'assign an array' do
    ...
    # foo = [ "some string", NodeName, 42, 3.141, 2d, true, ]
    is_expected.to run.with_params({'foo' => ['some string', 'NodeName', '42', '3.141', '2.5d', 'true']}).and_return("foo = [ \"some string\", NodeName, 42, 3.141, 2.5d, true, ]\n")

    # vars.foo = [ "some string", NodeName, 42, 3.141, 2d, true, ]
    is_expected.to run.with_params({'vars' => {'foo' => ['some string', 'NodeName', '42', '3.141', '2.5d', 'true']}}).and_return("vars.foo = [ \"some string\", NodeName, 42, 3.141, 2.5d, true, ]\n")
  end
  ...
  it 'assign a hash' do
    ...
    #   bool = true
    # }
    is_expected.to run.with_params({'foo' => { 'string' => 'some string', 'constant' => 'NodeName', 'numbers' => ['42', '3.141', '-42', '-3.141'], 'time' => '2.5d', 'bool' => 'true' }}).and_return("foo = {\n  string = \"some string\"\n  constant = NodeName\n  numbers = [ 42, 3.141, -42, -3.141, ]\n  time = 2.5d\n  bool = true\n}\n")

    # vars.foo["string"] = "some string"
    # vars.foo["constant"] = NodeName
    # vars.foo["numbers"] = [ 42, 3.141, -42, -3.141, ]
    # vars.foo["time"] = 2.5d
    # vars.foo["bool"] = true
    is_expected.to run.with_params({'vars' => {'foo' => { 'string' => 'some string', 'constant' => 'NodeName', 'numbers' => ['42', '3.141', '-42', '-3.141'], 'time' => '2.5d', 'bool' => 'true'}}}).and_return("vars.foo[\"string\"] = \"some string\"\nvars.foo[\"constant\"] = NodeName\nvars.foo[\"numbers\"] = [ 42, 3.141, -42, -3.141, ]\nvars.foo[\"time\"] = 2.5d\nvars.foo[\"bool\"] = true\n")
  end
  ...
  it 'assign a nested hash' do
    ...
    #   }
    # }
    is_expected.to run.with_params({'foobar' => { 'foo' => { 'string' => 'some string', 'constant' => 'NodeName', 'bool' => 'true' }, 'bar' => {'numbers' => ['42', '3.141', '-42', '-3.141'], 'time' => '2.5d' }}}).and_return("foobar = {\n  foo = {\n    string = \"some string\"\n    constant = NodeName\n    bool = true\n  }\n  bar = {\n    numbers = [ 42, 3.141, -42, -3.141, ]\n    time = 2.5d\n  }\n}\n")
    ...
    #   time = 2.5d
    # }
    is_expected.to run.with_params({'vars' => {'foobar' => { 'foo' => { 'string' => 'some string', 'constant' => 'NodeName', 'bool' => 'true' }, 'bar' => {'numbers' => ['42', '3.141', '-42', '-3.141'], 'time' => '2.5d' }}}}).and_return("vars.foobar[\"foo\"] = {\n  string = \"some string\"\n  constant = NodeName\n  bool = true\n}\nvars.foobar[\"bar\"] = {\n  numbers = [ 42, 3.141, -42, -3.141, ]\n  time = 2.5d\n}\n")
  end
