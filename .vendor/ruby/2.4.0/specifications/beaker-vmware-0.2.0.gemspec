# -*- encoding: utf-8 -*-
# stub: beaker-vmware 0.2.0 ruby lib

Gem::Specification.new do |s|
  s.name = "beaker-vmware".freeze
  s.version = "0.2.0"
  ...
  s.executables = ["beaker-vmware".freeze]
  s.files = ["bin/beaker-vmware".freeze]
  s.homepage = "https://github.com/puppetlabs/beaker-vmware".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<fission>.freeze, ["~> 0.4"])
      ...
      s.add_dependency(%q<fission>.freeze, ["~> 0.4"])
