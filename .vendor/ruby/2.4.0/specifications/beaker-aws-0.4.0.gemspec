# -*- encoding: utf-8 -*-
# stub: beaker-aws 0.4.0 ruby lib

Gem::Specification.new do |s|
  s.name = "beaker-aws".freeze
  s.version = "0.4.0"
  ...
  s.executables = ["beaker-aws".freeze]
  s.files = ["bin/beaker-aws".freeze]
  s.homepage = "https://github.com/puppetlabs/beaker-aws".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<aws-sdk-v1>.freeze, ["~> 1.57"])
    else
      ...
      s.add_dependency(%q<aws-sdk-v1>.freeze, ["~> 1.57"])
    end
  else
    s.add_dependency(%q<rspec>.freeze, ["~> 3.0"])
    s.add_dependency(%q<rspec-its>.freeze, [">= 0"])
