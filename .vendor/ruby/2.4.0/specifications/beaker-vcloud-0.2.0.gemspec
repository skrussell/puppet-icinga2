# -*- encoding: utf-8 -*-
# stub: beaker-vcloud 0.2.0 ruby lib

Gem::Specification.new do |s|
  s.name = "beaker-vcloud".freeze
  s.version = "0.2.0"
  ...
  s.executables = ["beaker-vcloud".freeze]
  s.files = ["bin/beaker-vcloud".freeze]
  s.homepage = "https://github.com/puppetlabs/beaker-vcloud".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<beaker-vmpooler>.freeze, [">= 0"])
      s.add_runtime_dependency(%q<beaker-vmware>.freeze, [">= 0"])
    else
      ...
      s.add_dependency(%q<beaker-vmware>.freeze, [">= 0"])
    end
  else
    s.add_dependency(%q<rspec>.freeze, ["~> 3.0"])
    s.add_dependency(%q<rspec-its>.freeze, [">= 0"])
