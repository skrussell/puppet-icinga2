# -*- encoding: utf-8 -*-
# stub: beaker-google 0.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "beaker-google".freeze
  s.version = "0.1.0"
  ...
  s.executables = ["beaker-google".freeze]
  s.files = ["bin/beaker-google".freeze]
  s.homepage = "https://github.com/puppetlabs/beaker-google".freeze
