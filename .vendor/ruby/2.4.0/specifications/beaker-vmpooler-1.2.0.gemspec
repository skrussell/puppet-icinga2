# -*- encoding: utf-8 -*-
# stub: beaker-vmpooler 1.2.0 ruby lib

Gem::Specification.new do |s|
  s.name = "beaker-vmpooler".freeze
  s.version = "1.2.0"
  ...
  s.executables = ["beaker-vmpooler".freeze]
  s.files = ["bin/beaker-vmpooler".freeze]
  s.homepage = "https://github.com/puppetlabs/beaker-vmpooler".freeze
