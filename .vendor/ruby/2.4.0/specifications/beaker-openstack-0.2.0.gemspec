# -*- encoding: utf-8 -*-
# stub: beaker-openstack 0.2.0 ruby lib

Gem::Specification.new do |s|
  s.name = "beaker-openstack".freeze
  s.version = "0.2.0"
  ...
  s.executables = ["beaker-openstack".freeze]
  s.files = ["bin/beaker-openstack".freeze]
  s.homepage = "https://github.com/puppetlabs/beaker-openstack".freeze
